...
%encontrarTudo('700500601','100100103','Aquisicao de servicos',_-_-2021,CS),calculaValorTotal(CS, VT), confirmaValor(VT+100000). 
%encontrarTudo('700500601','100100103','Aquisicao de servicos',_-_-2021,CS),calculaValorTotal(CS, VT), confirmaValor(VT+1000). 
