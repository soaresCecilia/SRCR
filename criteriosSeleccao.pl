...
contratoID(IdC, L) :-
solucoes(contrato(IdC,IdAd,IdAda,TC,TP,Des,C,P,Local,Data),
contrato(IdC,IdAd,IdAda,TC,TP,Des,C,P,Local,Data),L).


% Identificar Contrato pelo Adjudicante
contratoIDAd(IdAd, L) :-
solucoes(contrato(_,IdAd,_,_,_,_,_,_,_,_),
