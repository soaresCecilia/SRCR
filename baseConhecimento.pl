...
contrato(1,'700700707','100100102', 'Aquisicao de servicos', 'Ajuste Direto', 'Requalificacao do acesso ao parque de estacionamento da sede do Ministerio', '4000,00', 30, 'Largo do Rilvas, Lisboa', '11-03-2018').


contrato(2,'707070707','100100104' , 'Aquisicao de bens', 'Concurso Publico', 'Aquisicao de 40 dispositivos de acesso a rede sem fios', '10122,80', 90, 'Municipio de Guimaraes', '08-04-2020').



contrato(3,'700500650','100100100', 'Aquisicao de bens', 'Concurso Publico', 'Consumiveis para cirurgia catarata,vitrectomia e combinada', '93.360,00', 100, 'Alameda Santo Antonio dos Capuchos, Lisboa', '09-04-2020').


contrato(4,'700500601','100100103','Aquisicao de servicos', 'Aquisicao de servicos de manutencao preventiva, corretiva e assistencia tecnica aos equipamentos de ventilacao', '70088,60', 45, 'Edificio da Santa Casa da Misericordia de Lisboa', '09-04-2020').
